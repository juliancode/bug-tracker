...
export const Bug = ({
  ...
  switch (status) {
          ...
          <div className="status_0">
            <div className="main">
              ...
              <div className="buttons">
                ...
                <Button id={id} index={index} workingOn={workingOn} type={1}>
                  Working On
                </Button>
                <Button id={id} index={index} deleteBug={deleteBug} type={2}>
                  Archive
                </Button>
              </div>
            </div>
            <div className="details">
              ...
              <div className="date" title={format_date}>
                {relative_date}
              </div>
            </div>
          </div>
    ...
    default:
      return (
        <BugContainer>
          <Button type={status} workingOn={workingOn}>
            Sweg
          </Button>
        </BugContainer>
      );
